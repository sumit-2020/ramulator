...
namespace ramulator
{
  ...
  template <typename T>
    ...
    Scheduler(Controller<T>* ctrl) : ctrl(ctrl) {}
      ...
      list<Request>::iterator get_head(list<Request>& q, list<Request>& q2)
	{
	  ...
	  else if ( type == Type::AHB ){
	    if (!q.size() && !q2.size())
	      return q.end();

	    auto head = (q.size()) ? q.begin() : q2.begin();
	    if(q.size()) {
	      for (auto itr = next(q.begin(), 1); itr != q.end(); itr++)
	...
	// AHB
	  ...
	  //............................................................................................................
	  if(this->ctrl->choice==3)
	    return PowerAwarearbiter(req1,req2);
	  if(this->ctrl->choice==2)
	    if (req1->type == Request::Type::READ || req1->type == Request::Type::WRITE || req2->type == Request::Type::READ || req2->type == Request::Type::WRITE)
	      return AHBarbiter(req1,req2);
    	  //............................................................................................................
	  return compare[int(Type::FRFCFS_PriorHit)](req1, req2);}
      };

      ReqIter PowerAwarearbiter(ReqIter req1, ReqIter req2) {
	//cout<<"PowerAware\n";
	bool veryready1 = (req1->addr_vec[int(T::Level::Bank)]==this->ctrl->bankhistory[1]);
	bool veryready2 = (req2->addr_vec[int(T::Level::Bank)]==this->ctrl->bankhistory[1]);
	bool ready1       = (req1->addr_vec[int(T::Level::Bank)]==this->ctrl->bankhistory[0]);
	bool ready2       = (req2->addr_vec[int(T::Level::Bank)]==this->ctrl->bankhistory[0]);
	 if (veryready1 ^ veryready2) {
	    if (veryready1) return req1;
	    return req2;
	  }
	  if (ready1 ^ ready2) {
	    if (ready1) return req1;
	...
	if(this->ctrl->history[0] == T::Command::RD    && this->ctrl->history[1] == T::Command::RD    )
	 return (this->ctrl->arbiter==1) ? ret_any_WR(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_WR(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::RD    && this->ctrl->history[1] == T::Command::RDA   )
	 return (this->ctrl->arbiter==1) ? ret_any_WR(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_WR(req1,req2) : ret_any_WR(req1,req2) );  
	if(this->ctrl->history[0] == T::Command::RD    && this->ctrl->history[1] == T::Command::WR    )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RW(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::RD    && this->ctrl->history[1] == T::Command::WRA   )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RW(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::RDA   && this->ctrl->history[1] == T::Command::RD    )
	 return (this->ctrl->arbiter==1) ? ret_any_WR(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_WR(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::RDA   && this->ctrl->history[1] == T::Command::RDA   )
	 return (this->ctrl->arbiter==1) ? ret_any_WR(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_WR(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::RDA   && this->ctrl->history[1] == T::Command::WR    )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RW(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::RDA   && this->ctrl->history[1] == T::Command::WRA   )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RW(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::WR    && this->ctrl->history[1] == T::Command::RD    )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RW(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::WR    && this->ctrl->history[1] == T::Command::RDA   )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RW(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::WR    && this->ctrl->history[1] == T::Command::WR    )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RD(req1,req2) : ret_any_RD(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::WR    && this->ctrl->history[1] == T::Command::WRA   )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RD(req1,req2) : ret_any_RD(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::WRA   && this->ctrl->history[1] == T::Command::RD    )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RW(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::WRA   && this->ctrl->history[1] == T::Command::RDA   )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RW(req1,req2) : ret_any_WR(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::WRA   && this->ctrl->history[1] == T::Command::WR    )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RD(req1,req2) : ret_any_RD(req1,req2) ); 
	if(this->ctrl->history[0] == T::Command::WRA   && this->ctrl->history[1] == T::Command::WRA   )
	 return (this->ctrl->arbiter==1) ? ret_any_RD(req1,req2) : ( (this->ctrl->arbiter==2) ? ret_any_RD(req1,req2) : ret_any_RD(req1,req2) );
	
	return compare[int(Type::FRFCFS_PriorHit)](req1, req2); //just in case
     }

      ReqIter ret_any_RD(ReqIter req1, ReqIter req2){
	if(req1->type == Request::Type::READ && req2->type != Request::Type::READ)return req1;
	if(req2->type == Request::Type::READ && req1->type != Request::Type::READ)return req2;
	return compare[int(Type::FRFCFS_PriorHit)](req1, req2);
      }
      ReqIter ret_any_WR(ReqIter req1, ReqIter req2){
	if(req1->type == Request::Type::WRITE && req2->type != Request::Type::WRITE)return req1;
	if(req2->type == Request::Type::WRITE && req1->type != Request::Type::WRITE)return req2;
	return compare[int(Type::FRFCFS_PriorHit)](req1, req2);
      }
      ReqIter ret_any_RW(ReqIter req1, ReqIter req2){
	return compare[int(Type::FRFCFS_PriorHit)](req1, req2);	
      }
