...
namespace ramulator {
	...
	bool *powerup_pending ; // array to track which ranks are powering up at present*/
        ...
        bool is_poweringdown(Command cmd) {
            switch (int(cmd)) {
                case int(Command::PDN_F_PRE):
                case int(Command::PDN_S_PRE):
                case int(Command::PDN_F_ACT):
                case int(Command::PDN_S_ACT):
                    return true;
                default:
                    return false;
            }
        ...
        bool is_poweringup(Command cmd) {
            switch (int(cmd)) {
                case int(Command::PUP_ACT):
                case int(Command::PUP_PRE):
                    return true;
                default:
                    return false;
            }
        ...
        struct SpeedEntry {
            ...
            int nCKESR, nXS, nXSDLL;
                ...
                {800,  (400.0 / 3) * 3,
                                        (3 / 0.4) /
                                        3, 4, 4, 2, 5,  5,  5,  5,  15, 20, 4, 4, 6,  0, 0, 0, 3120, 3, 3, 10, 4, 0, 512},
                {800,  (400.0 / 3) * 3, (3 / 0.4) /
                                        3, 4, 4, 2, 6,  6,  6,  5,  15, 21, 4, 4, 6,  0, 0, 0, 3120, 3, 3, 10, 4, 0, 512},
                {1066, (400.0 / 3) * 4, (3 / 0.4) /
                                        4, 4, 4, 2, 6,  6,  6,  6,  20, 26, 4, 4, 8,  0, 0, 0, 4160, 3, 4, 13, 4, 0, 512},
                {1066, (400.0 / 3) * 4, (3 / 0.4) /
                                        4, 4, 4, 2, 7,  7,  7,  6,  20, 27, 4, 4, 8,  0, 0, 0, 4160, 3, 4, 13, 4, 0, 512},
                {1066, (400.0 / 3) * 4, (3 / 0.4) /
                                        4, 4, 4, 2, 8,  8,  8,  6,  20, 28, 4, 4, 8,  0, 0, 0, 4160, 3, 4, 13, 4, 0, 512},
                {1333, (400.0 / 3) * 5, (3 / 0.4) /
                                        5, 4, 4, 2, 8,  8,  8,  7,  24, 32, 5, 5, 10, 0, 0, 0, 5200, 4, 4, 16, 5, 0, 512},
                {1333, (400.0 / 3) * 5, (3 / 0.4) /
                                        5, 4, 4, 2, 9,  9,  9,  7,  24, 33, 5, 5, 10, 0, 0, 0, 5200, 4, 4, 16, 5, 0, 512},
                {1600, (400.0 / 3) * 6, (3 / 0.4) /
                                        6, 4, 4, 2, 9,  9,  9,  8,  28, 37, 6, 6, 12, 0, 0, 0, 6240, 4, 5, 20, 5, 0, 512},
                {1600, (400.0 / 3) * 6, (3 / 0.4) /
                                        6, 4, 4, 2, 10, 10, 10, 8,  28, 38, 6, 6, 12, 0, 0, 0, 6240, 4, 5, 20, 5, 0, 512},
                {1600, (400.0 / 3) * 6, (3 / 0.4) /
                                        6, 4, 4, 2, 11, 11, 11, 8,  28, 39, 6, 6, 12, 0, 0, 0, 6240, 4, 5, 20, 5, 0, 512},
                {1866, (400.0 / 3) * 7, (3 / 0.4) /
                                        7, 4, 4, 2, 11, 11, 11, 9,  32, 43, 7, 7, 14, 0, 0, 0, 7280, 5, 6, 23, 6, 0, 512},
                {1866, (400.0 / 3) * 7, (3 / 0.4) /
                                        7, 4, 4, 2, 12, 12, 12, 9,  32, 44, 7, 7, 14, 0, 0, 0, 7280, 5, 6, 23, 6, 0, 512},
                {2133, (400.0 / 3) * 8, (3 / 0.4) /
                                        8, 4, 4, 2, 12, 12, 12, 10, 36, 48, 8, 8, 16, 0, 0, 0, 8320, 6, 7, 26, 7, 0, 512},
                {2133, (400.0 / 3) * 8, (3 / 0.4) /
                                        8, 4, 4, 2, 13, 13, 13, 10, 36, 49, 8, 8, 16, 0, 0, 0, 8320, 6, 7, 26, 7, 0, 512}
        }, speed_entry;
	...
	/*void update_powerdown_pending(const vector<int>& addr_vec){
	    ...
	    cout<<"\n Powerdown_pending contents : ";
	    for(int y=0;y<org_entry.count[int(Level::Rank)];y++)cout<<powerdown_pending[y]<<" ";cout<<"\n";
	}

	void update_powerup_pending(const vector<int>& addr_vec){
        powerup_pending[addr_vec[int(DDR3::Level::Rank)]]=true;
        cout<<"\n UPDATE_POWERUP_PENDING was called !\n";
